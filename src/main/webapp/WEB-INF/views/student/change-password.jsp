						...
						<div class="page-content row">
							<form class="form-horizontal" id="form-change-password" action="change-pwd" style="margin-top:40px;" method="post">
									...
									<div class="form-group form-password">
										<label class="control-label col-xs-4" for="email" style="text-align: center;">新密码</label>
										<div class="col-md-7">
									...
									<div class="form-group form-password-confirm">
										<label class="control-label col-xs-4" for="password" style="text-align: center;">确认新密码</label>
										<div class="col-md-7">
